...
console.log("auth user in navbar:::", authUser)
    ...
    return (
        <div
            ...
            ${sticky ? "shadow-md bg-base-200 dark:bg-slate-700 duration-300 transition-all ease-in-out" : "bg-white dark:bg-slate-800 dark:text-white"}`}
        >
            <div className="navbar">
                <div className="navbar-start">
                    <div className="dropdown">
                    ...
                    <a className="text-xl font-bold cursor-pointer dark:text-white">Book Store</a>
                </div>
                <div className="navbar-end space-x-3">
                    <div className="navbar-center hidden lg:flex">
                    ...
                    <div className="hidden md:block">
                        <label className="px-3 py-2 border rounded-md flex items-center gap-2 dark:bg-slate-700 dark:border-slate-600">
                            <input
                                type="text"
                    ...
                    <div>
                        <label className="swap swap-rotate pt-2" onClick={toggleTheme}>
                            <input
                                type="checkbox"
                            ...
                            >
                                <path
                                    d="M5.64,17l-.71.71a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0l.71-.71A1,1,0,0,0,5.64,17ZM5,12a1,1,0,0,0-1-1H3a1,1,0,0,0,0,2H4A1,1,0,0,0,5,12Zm7-7a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4A1,1,0,0,0,12,5ZM5.64,7.05a1,1,0,0,0,.7.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.41l-.71-.71A1,1,0,0,0,4.93,6.34Z"
                                />
                            </svg>
                            {/* Moon icon */}
                            <svg
